...
namespace WebApiBestBuy.Services
{
    public class UserService : IUserService
    {
        ...
        public UserService(UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, RoleManager<IdentityRole> role, INotificationContext notificationContext)
        {
        ...
        public Token GenerateToken(IdentityUser userInfo)
        {
